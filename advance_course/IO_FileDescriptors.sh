...
# a file that describes what the file is for and how to use it. We have already
# used $? to get the status status code of a command. Not realizing that that the
...
echo -e "UNDERSTANDING IO_FILEDESCRIPTOR\n"
